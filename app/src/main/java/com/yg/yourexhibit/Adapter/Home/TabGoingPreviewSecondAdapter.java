...
public class TabGoingPreviewSecondAdapter extends RecyclerView.Adapter<TabGoingPreviewViewHolder>{

    private ArrayList<ExhibitDetailImages> previewList;
    private RequestManager requestManager;
    private View.OnClickListener onItemClick;

    public TabGoingPreviewSecondAdapter(ArrayList<ExhibitDetailImages> previewList, RequestManager requestManager, View.OnClickListener onItemClick) {
